...
export const messageFromHoD = {
  message: `Welcome to the Department of Computer Science and Engineering (Artificial Intelligence) at the Institute of Engineering & Management, New Town, University of Engineering and Management, Kolkata. We extend a warm welcome to all students and their parents as they embark on this exciting journey. Our CSE (AI) department is at the forefront of today’s technological advancements. We are dedicated to provide not just a robust technical education, but also instilling leadership qualities that empower our students to create opportunities for others. The University of Engineering and Management, Kolkata, carries forward the proud legacy of 35 years of academic excellence from the IEM-UEM Group. Our vision at UEM is to produce not only proficient technologists but also individuals grounded in human values and Indian ethos. As a center of excellence, UEM integrates technology, science, and human values, ensuring that our students receive an education that is both comprehensive and relevant to real-world challenges. At our campus, we focus on the holistic development of our students by blending curricular and extracurricular activities. We believe that nurturing young minds extends beyond classroom teaching, and we are committed to making our students industry-ready. In our department, students will delve into the core aspects of computer science and engineering, including programming, computer graphics, networking, software engineering, and more. We emphasize critical areas such as high-speed networks, soft computing, algorithm design, network security, and advanced database systems. Additionally, we focus on enhancing students’ soft skills, analytical abilities, and communication skills to ensure they are well-prepared for the competitive corporate world. Our department boasts excellent infrastructure, a dedicated teaching faculty, and a strong Training and Placement Cell, all of which contribute to a bright future for our students. We strive to provide innovative and high-quality education, creating a platform for students to achieve their career aspirations. Our faculty is a team of highly experienced and motivated individuals who are committed to shaping young minds into globally competitive professionals. Through innovative teaching methods, hands-on practice, and continuous motivation, we aim to enhance our students’ learning abilities. The department’s state-of-the-art infrastructure and computing facilities create an environment conducive to academic and research excellence. I extend my congratulations to the faculty members and students for their brilliant efforts and dedication. I wish all our students and faculty members a successful and fulfilling academic journey.`,

  name: "Head of the Department",
  dept: "CSE (AI)",
  institute: "IEM, New Town",
